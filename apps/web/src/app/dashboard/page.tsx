    ...
    <div className="px-8 py-8 max-w-4xl">
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-3">
          ...
          <a href="/dashboard/classes/new" className="text-xs text-zinc-500 hover:text-zinc-900">
            + Add class
          </a>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <a href="/dashboard/assessments" className="text-xs text-zinc-500 hover:text-zinc-900">
            View all
          </a>
        </div>
